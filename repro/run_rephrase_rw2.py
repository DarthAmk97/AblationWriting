...
jobs = json.load(open("rephrase_rw2_jobs.json", encoding="utf-8"))
...
outs = []
for j in jobs:
    set_seed(stable_prompt_seed(j["job"] + "-rw2"))
    ...
    json.dump(outs, open("rephrase_rw2_outs.json", "w", encoding="utf-8"), indent=1)
