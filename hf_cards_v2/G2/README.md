...
# Cone-ablated Gemma-4-E2B for writing, H2 frozen run

## Abstract

Gemma-4-E2B-it with a frozen rank-8 safety cone hooked into layers 11 to 16. TEST MMD recovery +0.193 against random at -0.067, while lexical deletion barely registers at +0.028. The cleanest cone win on the panel. Blind quality preference is parity at 0.490. No GGUF by design, see Usage.
...
```text
base = google/gemma-4-E2B-it, rev 3e22461f
...
for layer in [11, 12, 13, 14, 15, 16]:
    ...
    hook = GeneratedTokenHook(B, mu, alpha=0.5)            # generated tokens only
    register(layer, hook)
