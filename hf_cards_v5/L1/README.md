...
TEST MMD recovery hits +0.092 against a dose-matched random control at -0.036, proving direction matters more than just dose. Lexical deletion ties the cone here at +0.062. Blind quality preference zigs the wrong way at 0.343. No GGUF, by design, so see Usage.

Collection: [AblationWriting](https://huggingface.co/collections/amkkk/ablationwriting-6a9e1c709941b6e3fd1c1dea). Full dump: [AblationWriting-H2-dump](https://huggingface.co/amkkk/AblationWriting-H2-dump). Code and paper: [DarthAmk97/AblationWriting](https://github.com/DarthAmk97/AblationWriting). Sibling cards: OLMo-2 1B cone, Qwen3.5-0.8B cone, Qwen3.5-2B cone, Gemma-4-E2B cone, in the same collection.
...
- Siblings: [OLMo-2 1B cone](https://huggingface.co/amkkk/AblationWriting-H2-O1-cone), [Qwen3.5-0.8B cone](https://huggingface.co/amkkk/AblationWriting-H2-Q08-cone), [Qwen3.5-2B cone](https://huggingface.co/amkkk/AblationWriting-H2-Q20-cone), [Gemma-4-E2B cone](https://huggingface.co/amkkk/AblationWriting-H2-G2-cone)
- Collection: [AblationWriting](https://huggingface.co/collections/amkkk/ablationwriting-6a9e1c709941b6e3fd1c1dea)
